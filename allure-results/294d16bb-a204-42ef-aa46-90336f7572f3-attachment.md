...
- main [ref=e2]:
  ...
  - generic [ref=e5]:
    ...
    - generic [ref=e18]:
      - button "Log In" [disabled] [ref=e19]
      - link "Contact Us" [ref=e21] [cursor=pointer]:
        - /url: /static/contact-us
    - generic [ref=e22]:
      - paragraph [ref=e23]: © 2026 All rights reserved.
      - paragraph [ref=e24]: Access is restricted to authorized users who have been issued valid login credentials by Energy Worldnet. If you are not an authorized user, exit now to avoid possible civil or criminal liability.
```