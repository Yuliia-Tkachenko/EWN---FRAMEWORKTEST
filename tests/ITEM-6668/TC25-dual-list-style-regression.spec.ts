...
test.describe('TC25 — Dual list component renders correctly after filter introduction (style regression)', () => {
  ...
  test('TC25: dual list is visible and contains items after company selection', async () => {
    ...
    // Step 5: Expect the available items count to be greater than 0
